...
\setbeamertemplate{headline}{
  ...
  \begin{columns}
    ...
    \begin{column}{.7\paperwidth}
      \vskip2cm
      \centering
      \usebeamercolor{title in headline}{\color{fg}\textbf{\fontsize{60}{80}\selectfont \inserttitle}\\[2ex]}
      \vskip1.5cm
    ...
    \begin{column}{.2\paperwidth}
      \flushright
      \includegraphics[height=8cm,keepaspectratio]{logo.jpeg}\hspace*{2cm}
    \end{column}
  \end{columns}
  \vskip2cm
}
...
\tikzset{
    process/.style={rectangle, draw=neoncyan, fill=bgdark, text=titletext, very thick, minimum width=8cm, minimum height=2cm, align=center, rounded corners, drop shadow},
    decision/.style={diamond, draw=neonmagenta, fill=bgdark, text=titletext, very thick, minimum width=3cm, minimum height=3cm, align=center, drop shadow},
    io/.style={trapezium, trapezium left angle=70, trapezium right angle=110, draw=neongreen, fill=bgdark, text=titletext, very thick, minimum width=8cm, minimum height=2cm, align=center, drop shadow},
