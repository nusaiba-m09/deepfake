...
\setbeamertemplate{headline}{
  ...
  \begin{columns}
    ...
    \begin{column}{.2\paperwidth}
      \centering
      \includegraphics[height=12cm,keepaspectratio]{logo.jpeg}
    \end{column}
  \end{columns}
  \vskip2cm
}
...
\begin{block}{Neural Architecture}
    \vspace{0.3cm}
    \begin{center}
        \includegraphics[width=0.65\linewidth]{sleek_diagram.jpg}
    \end{center}
    \vspace{0.3cm}
\end{block}
\end{column}
...
\begin{block}{Real-Time Artifact Localization}
    \vspace{0.3cm}
    \begin{center}
        \includegraphics[width=0.7\linewidth]{heatmap.jpg}
    \end{center}
    \vspace{0.3cm}
\end{block}
\end{column}
...
\begin{block}{Attention-Based Artifact Detection}
    \vspace{0.5cm}
    \begin{center}
        \includegraphics[width=0.75\linewidth]{sleek_concept.jpg}
    \end{center}
    \vspace{0.5cm}
