...
\begin{block}{The Deep Learning Solution}
    ...
    \resizebox{0.9\linewidth}{!}{
        \begin{tikzpicture}[node distance=1.5cm and 1cm]
            \node (cnn) [rectangle, draw=neongreen, fill=bgblock, text=white, very thick, minimum width=10cm, minimum height=3cm, align=center, drop shadow] {\Huge \textbf{PyTorch Meso4 CNN}};
...
\begin{block}{AI Inference Pipeline}
    ...
    \resizebox{0.95\linewidth}{!}{
        \begin{tikzpicture}[node distance=2.5cm and 2cm]
            ...
            \node (nn) [process, below=of sample] {\textbf{Meso4 CNN} \\ (Feature Extraction)};
...
% ==================== COLUMN 3 ====================
\begin{column}{.31\paperwidth}
\begin{block}{Mesoscopic Artifact Detection}
    \vspace{1cm}
    \begin{center}
        \includegraphics[width=0.9\linewidth]{concept.jpg}
    \end{center}
    \vspace{1cm}
    \centering \Large \textit{Unlike macroscopic facial analysis, Meso4 targets sub-pixel blending edges and boundary warping where generators fail.}
    \vspace{1cm}
\end{block}
