...
\setbeamertemplate{headline}{
  ...
  \begin{columns}
    ...
    \begin{column}{.7\paperwidth}
      \vskip2cm
      \centering
      \usebeamercolor{title in headline}{\color{fg}\textbf{\fontsize{75}{100}\selectfont \inserttitle}\\[2ex]}
      \vskip1.5cm
    ...
    \begin{column}{.2\paperwidth}
      \flushright
      \includegraphics[height=8cm,keepaspectratio]{logo.jpg}\hspace*{2cm}
    \end{column}
  \end{columns}
  \vskip2cm
}
...
\begin{block}{Problem Statement: The Deepfake Threat}
    \vspace{0.5cm}
    \Large \textbf{The Context:} The proliferation of hyper-realistic synthetic media poses severe threats across multiple sectors in Bangladesh and globally, from digital finance to public discourse.
    
    \vspace{0.3cm}
    \Large \textbf{The Challenge:} Deepfakes drive Mobile Financial Services (MFS) fraud (e.g., e-KYC bypass), political misinformation, identity theft, and non-consensual imagery. Standard security protocols are failing against these advanced AI threats.
    \vspace{0.3cm}
    \begin{center}
...
\begin{block}{Real-Time Artifact Localization}
    \vspace{0.3cm}
    \begin{center}
        \includegraphics[width=0.75\linewidth]{heatmap.jpg}
    \end{center}
    \vspace{0.3cm}
\end{block}
\end{column}
...
\begin{block}{Neural Architecture}
    \vspace{0.3cm}
    \begin{center}
        \includegraphics[width=0.7\linewidth]{sleek_diagram.jpg}
    \end{center}
    \vspace{0.3cm}
\end{block}
...
\begin{block}{Attention-Based Artifact Detection}
    \vspace{0.3cm}
    \begin{center}
        \includegraphics[width=0.7\linewidth]{sleek_concept.jpg}
    \end{center}
    \vspace{0.3cm}
...
\begin{block}{Impact \& Future Scope}
    ...
    \begin{itemize}
        ...
        \begin{itemize}
            ...
            \item[\textcolor{neonmagenta}{\textbf{--}}] \large AI-synthesized audio/video impersonating officials for social engineering.
