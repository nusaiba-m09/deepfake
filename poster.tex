...
\setbeamertemplate{headline}{
  ...
  \begin{columns}
    ...
    \begin{column}{.7\paperwidth}
      \vskip2cm
      \centering
      \usebeamercolor{title in headline}{\color{fg}\textbf{\fontsize{80}{95}\selectfont \inserttitle}\\[1ex]}
      \vskip1.5cm
      \usebeamercolor{author in headline}{\color{fg}\huge{\textbf{\insertauthor}}\\[1.5ex]}
...
\begin{block}{Problem Statement: The Deepfake Threat}
    \vspace{0.5cm}
    \Large \textbf{The Context:} Rapid adoption of Mobile Financial Services (MFS) like bKash and Nagad in Bangladesh has introduced severe vulnerabilities to AI-driven fraud.
    
    \vspace{0.5cm}
    \Large \textbf{The Challenge:} Deepfakes are actively used to bypass e-KYC liveness detection and impersonate officials or relatives, leading to massive financial scams. Standard biometric protocols are no longer sufficient against synthetic media.
    \vspace{0.5cm}
    \begin{center}
    \resizebox{0.9\linewidth}{!}{
        \begin{tikzpicture}[node distance=1.5cm and 2cm]
            ...
            \node (threat1) [rectangle, draw=neoncyan, fill=bgdark, text=white, very thick, minimum width=6cm, minimum height=2cm, align=center, above right=of df, xshift=1cm] {\LARGE \textbf{e-KYC Bypass}};
            \node (threat2) [rectangle, draw=neoncyan, fill=bgdark, text=white, very thick, minimum width=6cm, minimum height=2cm, align=center, right=of df, xshift=2cm] {\LARGE \textbf{MFS Fraud}};
            \node (threat3) [rectangle, draw=neoncyan, fill=bgdark, text=white, very thick, minimum width=6cm, minimum height=2cm, align=center, below right=of df, xshift=1cm] {\LARGE \textbf{Impersonation}};
...
\begin{block}{Impact \& Future Scope}
    \vspace{0.5cm}
    \begin{itemize}
        \item[\textcolor{neoncyan}{\textbf{>}}] \Large \textbf{Custom Lightweight Model:} Developing a highly optimized, resource-efficient proprietary model tailored for real-time mobile edge devices.
        \vspace{0.5cm}
        \item[\textcolor{neoncyan}{\textbf{>}}] \Large \textbf{Tackling Bangladesh-Specific Scams:} Extending detection to combat localized threats:
        \begin{itemize}
            \item[\textcolor{neonmagenta}{\textbf{--}}] \large Bypassing e-KYC and liveness detection in MFS (bKash, Nagad).
            \item[\textcolor{neonmagenta}{\textbf{--}}] \large AI-synthesized audio/video impersonating bank officials for social engineering.
            \item[\textcolor{neonmagenta}{\textbf{--}}] \large Synthetic identity creation for fraudulent loan applications.
        \end{itemize}
        \vspace{0.5cm}
        \item[\textcolor{neoncyan}{\textbf{>}}] \Large \textbf{Multimodal Expansion:} Fusing audio and video analysis to detect deeply coordinated financial scams and restore digital trust.
    \end{itemize}
    \vspace{0.5cm}
\end{block}
\end{column}
