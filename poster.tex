...
\begin{minipage}[t][22cm][c]{\linewidth}
    \vspace{0.5cm}
    \begin{itemize}
        \item[\textcolor{neoncyan}{\textbf{>}}] \Large \textbf{The Context:} Rapid adoption of Mobile Financial Services (MFS) like bKash and Nagad has introduced severe vulnerabilities in Bangladesh.
        \vspace{1cm}
        \item[\textcolor{neoncyan}{\textbf{>}}] \Large \textbf{The Challenge:} Standard security protocols fail against advanced AI threats. Deepfakes are actively used to bypass e-KYC liveness detection and impersonate officials.
        \vspace{1cm}
        \item[\textcolor{neoncyan}{\textbf{>}}] \Large \textbf{The Impact:} Conventional biometric checks are no longer sufficient against hyper-realistic synthetic media, leading to massive financial scams.
    \end{itemize}
\end{minipage}
\end{block}

\begin{block}{The Deep Learning Solution}
\begin{minipage}[t][21cm][c]{\linewidth}
    \begin{center}
...
\begin{minipage}[t][20cm][c]{\linewidth}
    \begin{center}
        \includegraphics[height=18cm,keepaspectratio]{sleek_diagram.jpg}
    \end{center}
\end{minipage}
\end{block}
...
\begin{block}{Model Training \& Dataset}
\begin{minipage}[t][20cm][c]{\linewidth}
    \vspace{0.5cm}
    \begin{itemize}
        \item[\textcolor{neoncyan}{\textbf{>}}] \Large \textbf{Diverse Corpus:} Trained on a massive, diverse corpus of authentic and synthetic faces, including localized datasets representing South Asian demographics.
        \vspace{1cm}
        \item[\textcolor{neoncyan}{\textbf{>}}] \Large \textbf{Robustness:} Utilizes adversarial training techniques to ensure robustness against evolving generator networks and zero-day deepfake variants.
    \end{itemize}
\end{minipage}
\end{block}
...
\begin{minipage}[t][22cm][c]{\linewidth}
    \begin{center}
        \includegraphics[height=15cm,keepaspectratio]{sleek_concept.jpg}
    \end{center}
    \vspace{1cm}
...
\begin{minipage}[t][20cm][c]{\linewidth}
    \vspace{0.5cm}
    \begin{itemize}
        \item[\textcolor{neoncyan}{\textbf{>}}] \Large \textbf{Edge Computing:} Targeting deployment directly on mobile edge devices for real-time verification during e-KYC processes.
        \vspace{1cm}
        \item[\textcolor{neoncyan}{\textbf{>}}] \Large \textbf{Low Latency:} The lightweight model architecture ensures high-throughput inference with minimal latency, securing digital finance infrastructure immediately at the point of access.
    \end{itemize}
\end{minipage}
\end{block}
